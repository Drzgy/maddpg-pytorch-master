...
def run(config):
    ...
    #change env
    env=SCraftAdapter2(map_name='3m',step_mul=8,difficulty='3',game_version=None,replay_dir="")
    ...
    for ep_i in range(0, config.n_episodes, config.n_rollout_threads):
        ...
        for et_i in range(config.episode_length):
            ...
            #add argmax
            agent_actions = [np.argmax(ac.data.numpy()) for ac in torch_agent_actions]
